    ...
    <div className="w-full space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-500 dark:text-gray-400 text-sm mt-1">
          Connect with study mates, send requests, and chat in real-time
        </p>
      </div>
          ...
          <div className="bg-white dark:bg-gray-900 border dark:border-gray-800 rounded-xl p-4">
            ...
            <div className="flex gap-2">
              ...
              <button
                ...
                disabled={searching}
                className="bg-black dark:bg-white dark:text-black text-white text-sm px-4 py-2 rounded-lg font-medium hover:opacity-90 transition"
              >
                Search
              </button>
            </div>
                  ...
                  <div key={req.requestId} className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="text-xs bg-black dark:bg-white dark:text-black text-white px-2.5 py-1 rounded-md font-medium"
                      >
                        Accept
                      </button>
                      <button
                        onClick={() => handleRespondToRequest(req.requestId, req.id, false)}
                        className="text-xs border dark:border-gray-700 px-2.5 py-1 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800 dark:text-gray-300 transition"
                      >
                        Decline
                      </button>
                    </div>
              ...
              <div className="space-y-1">
                {friends.map((friend) => (
                  ...
                  >
                    ...
                    <p className="text-sm flex-1 dark:text-gray-300 font-medium">{friend.full_name}</p>
                    {unreadCounts[friend.id] > 0 && (
